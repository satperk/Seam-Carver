...
public:
  ...
  void EnergyCorner(int row, int col, Pixel& left, Pixel& across, Pixel& up, Pixel& down) const;
  
  void EnergyRowEnds(int row, int col, Pixel& left, Pixel& across, Pixel& up, Pixel& down) const;

  void EnergyColumnEnds(int row, int col, Pixel& left, Pixel& across, Pixel& up, Pixel& down) const;
  ...
  //populates horizontal seam
  void PopulateHorizontalSeam(int**& array) const;
  ...
  //populates vertical seam
  void PopulateVerticalSeam(int**& array) const;

  void RemoveVerticalSeamParse(Pixel** final_image, int* vertical_seam);
  ...
  void RemoveHorizontalSeamParse(Pixel**& final_image, int*& horizontal_seam);
