...
public:
  ...
  void HorizontalCarve(int const* array);
  void VerticalCarve(int const* array);
  // assignment operator
  //
  ...
  void RemoveHorizontalSeamHelper(Pixel** pixel); 

  void RemoveVerticalSeamHelper(Pixel** pixel);
